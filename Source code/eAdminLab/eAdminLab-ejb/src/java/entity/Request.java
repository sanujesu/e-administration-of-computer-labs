...
public class Request implements Serializable {
    ...
    @JoinColumn(name = "instructor", referencedColumnName = "userID", nullable = false)
    @ManyToOne(optional = false)
    ...
    public Request(String requestID, String title, String description, boolean statusID) {
        this.requestID = requestID;
        this.title = title;
    ...
    public Enduser getEnduser1() {
        return enduser1;
    }

    public void setEnduser1(Enduser enduser1) {
